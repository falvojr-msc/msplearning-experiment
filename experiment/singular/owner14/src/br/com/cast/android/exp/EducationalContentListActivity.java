...
public class EducationalContentListActivity extends BaseActivity {
	...
	void carregarListView() {
		List<EducationalContent> educationalContent = educationalContentRestClient.findByOwner(EducationalContent.ID_OWNER);
		carregarListView(educationalContent);
	}


	@UiThread
	void carregarListView(List<EducationalContent> educationalContent) {
		educationalListAdapter.setEducational(educationalContent);
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		final EducationalContent educationalContentSelecionado = educationalListAdapter.getItem(info.position);
		...
		case R.id.action_editar:
			...
			intent.putExtra(EducationalContentActivity.CHAVE_USUARIO, educationalContentSelecionado);
		...
		case R.id.action_excluir:
			...
			OnClickListener listenerSim = new OnClickListener() {
				...
				public void onClick(DialogInterface arg0, int arg1) {
					...
					deletarUsuario(educationalContentSelecionado);
				}
			};
			...
			.setMessage(String.format(getString(R.string.msg_dialog_confirmacao_exclusao), educationalContentSelecionado.getTitle()))
			.show();
	...
	@Background
	void deletarUsuario(EducationalContent educationalContent) {
		try {
